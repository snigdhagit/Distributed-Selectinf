...
class multisplit_lasso(gaussian_query):
    ...
    def _setup_implied_gaussian(self,
        ...
        for i in range(K):
            ...
            D = (self.opt_linear_dict[i])[ordered_vars] * scaling_matrix[i, i]
